...
Event studies are commonly used in finance^[A 2007 estimate puts the number of published papers in finance using an event study methodology at over 565 [@Kothari20073]] to identify the effect of an event on asset prices or returns and are often used in cases of small N, large T common to financial time series and extreme event modelling.
