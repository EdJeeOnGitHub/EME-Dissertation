# Generated on 2018-01-18 18:14:36 by gEcon ver. 1.0.2 (2016-12-05)
# http://gecon.r-forge.r-project.org/

# Model name: EZ_No_T

# info
info__ <- c("EZ_No_T", "C:/Users/nfa/Dropbox/Ed/Ed Uni work/EME/R/DSGE GCH Files/EZ_No_T.gcn", "2018-01-18 18:14:36")
...
freepareqmap__ <- sparseMatrix(i = c(1, 5, 6, 6, 6, 6, 8, 9, 9, 9),
                               j = c(5, 4, 1, 2, 3, 5, 2, 1, 3, 5),
...
pert1__ <- function(v, pc, pf)
{
    ...
    Atm1x[5] = 1 - pf[2]
    Atm1 <- sparseMatrix(i = c(2, 3, 4, 5, 8),
                         j = c(5, 5, 5, 9, 5),
                         x = Atm1x, dims = c(9, 9))
    ...
    Atx[14] = 1
    Atx[15] = -1
    Atx[16] = -pf[1] * (1 - pf[5])^-1 * v[1]^(-1 + (1 - pf[5])^-1)
    Atx[17] = -v[3]^(-pf[3])
    Atx[18] = 1
